//UK regional outwardPostcode correspondence enumeration by information source https://carbonintensity.org.uk
const Regions = Object.freeze({
    ...
    NORTH_WEST_ENGLAND: {
        ...
        outwardPostcodes: ["BB", "BD", "BL", "CA", "CH", "CW", "FY", "HD", "HX", "L", "LA", "M", "OL", "PR", "SK", "WA", "WN"],
    },
    NORTH_EAST_ENGLAND: {
        number: 4,
    ...
    LONDON: {
        number: 13,
        region: "London",
        outwardPostcodes: ["BR", "CR", "DA", "E", "EC", "EN", "IG", "KT", "N", "NW", "RM", "SE", "SM", "SW", "TW", "UB", "W", "WC", "WD"],
    },
    SOUTH_EAST_ENGLAND: {
        number: 14,

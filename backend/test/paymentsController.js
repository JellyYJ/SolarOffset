  ...
  describe("validatePaymentStatus Functionality", function () {
    it("should return a success message that the payment has been saved", function (done) {
      ...
      const req = {
        ...
        body: {
          sessionId:
            "cs_test_a1eBgOQVQHjFDGN9OUgO0CwebOn7CmnhaMIxNkusjVdo8QtWRJ527d6681",
      ...
      paymentController
        ...
        .then((result) => {
          ...
          expect(res.message).to.contain(
            "Country with ID 5c0f66b979af55031b39874a not found"
          );
          done();
        });
    });
    ...
    it("should throw an error if the panelId is not found", function (done) {
      ...
      paymentController
        ...
        .then((result) => {
          expect(res.statusCode).to.be.equal(500);
          expect(res.message).to.contain(
            "Solar panel with ID nullPanelId not found in country"
          );
          done();
        });
    });
    ...
    it("should throw an error if the payment has failed", function (done) {
      ...
      const req = {
        ...
        body: {
          sessionId:
            "cs_test_a1xjbUO92s0al7SWUvtY9kO83TwfQ97XzFIDA4P6SGKBBYm7G6XvC9CP4o",
          countryId: "5c0f66b979af55031b34728a",
          price: 100,
          panelId: "testpanel",
          country: "testcountry",
